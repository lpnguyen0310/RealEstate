...
public class PropertyServiceImpl implements IPropertyService {
    ...
    private final LegalVerificationService legalVerificationService;
...
//        }
    ...
    public CreatePropertyResponse create(Long userId, CreatePropertyRequest req,SubmitMode mode) {
        log.info("DEBUG REQUEST -> Legal URLs: {}", req.getLegalDocumentUrls());
        ...
        if (saved.getVerificationStatus() == VerificationStatus.PENDING_SCAN) {
            log.info("Kích hoạt quét AI pháp lý cho Property ID: {}", saved.getId());
            legalVerificationService.scanAndScore(saved.getId());
        }
    ...
    public CreatePropertyResponse update(Long userId, Long propertyId, CreatePropertyRequest req, @Nullable SubmitMode mode) {
        ...
        if (saved.getVerificationStatus() == VerificationStatus.PENDING_SCAN) {
            log.info("Kích hoạt quét lại AI pháp lý cho Property ID: {}", saved.getId());
            legalVerificationService.scanAndScore(saved.getId());
        }
