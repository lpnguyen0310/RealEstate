...
import { Flex, Badge, Avatar, Dropdown, Button } from "antd";
import { HeartOutlined, BellOutlined, DownOutlined } from "@ant-design/icons";
    ...
    return (
        <header className="sticky top-0 z-50 mx-auto bg-white border-b border-gray-200 w-full px-4 py-2">
            <Flex align="center" justify="space-between" className="mx-auto w-full h-[72px] px-4">
                            ...
                            {NAVS.map((nav) => {
                                ...
                                const btn = (
                                    <button
                                        ...
                                        className={`relative text-[16px] font-medium text-gray-800 hover:text-gray-900 transition after:absolute after:left-0 after:right-0 after:-bottom-[6px] after:h-[2px] after:bg-[#d6402c] after:transition-transform after:origin-left after:transform
                                ...
                                return nav.items?.length ? (
                                    ...
                                    <a
                                        ...
                                        // Hover vào link thường → bật underline
                                        onMouseEnter={() => setHoverKey(nav.label)}
                                    >
                                        {btn}
                                    </a>
                ...
                {/* RIGHT: Actions */}
                <Flex align="center" className="px-2 w-[520px] max-w-[460px] min-w-[420px]" gap={0} justify="space-evenly">
