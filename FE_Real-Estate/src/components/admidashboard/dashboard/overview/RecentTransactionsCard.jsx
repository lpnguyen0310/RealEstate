        ...
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-[#e9eef7] h-full">
            ...
            <ul className="divide-y divide-gray-100">
                {displayItems.map((t, i) => (
                    <li
                        key={i}
                        className="grid items-center gap-4 py-3 px-2 -mx-2 rounded-xl hover:bg-gray-50/70 transition-colors [grid-template-columns:minmax(0,1fr)_150px_110px] min-h-[56px]"
                    >
                        {/* LEFT */}
                        <div className="flex items-center gap-3 min-w-0">
                            ...
                            >
                                <span className={`font-bold ${t.iniText} text-sm tracking-wide`}>
                                    {t.ini}
                                </span>
                            </div>
