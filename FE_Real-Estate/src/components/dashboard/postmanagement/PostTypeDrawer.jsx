                                ...
                                >
                                    ...
                                    >
                                        <div className="flex items-start justify-between mb-1">
                                            ...
                                            <span className="inline-flex items-center justify-center px-2.5 h-6 rounded-full text-[12px] leading-none font-semibold bg-[#2E5BFF] text-white shadow-sm line-clamp-1">
                                                {isActive ? "Chọn" : isCurrent ? "Hiện tại" : defaultBadge}
                                            </span>
                                        </div>
